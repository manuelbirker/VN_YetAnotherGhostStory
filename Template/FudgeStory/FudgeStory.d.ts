...
declare namespace FudgeStory {
    ...
    class Interactable extends Base {
        private static interactables;
        name: string;
        posX: number;
        posY: number;
        img: string;
        ...
        origin: ƒ.ORIGIN2D;
        private constructor();
        static get(_interactable: InteractableDefinition): Interactable;
        static getByName(_name: string): Interactable;
        static show(_interactable: InteractableDefinition, _pose: RequestInfo, _position: Position): Promise<void>;
        static hide(_interactable: InteractableDefinition): Promise<void>;
        static hideAll(): void;
        getPose(_pose: RequestInfo): Promise<ƒ.Node>;
        private createPose;
        private static clickable;
    }
}
declare namespace FudgeStory {
    /**
...
declare namespace FudgeStory {
    ...
    class Sound {
        ...
        static stop(_url: RequestInfo, _volume: number, _loop?: boolean): Sound;
        /**
